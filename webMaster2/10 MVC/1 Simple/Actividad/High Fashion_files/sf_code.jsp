...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.1.84";
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (this.testBucket == '2014w13_New_Hover' || this.testBucket == '2014w13_New_Hover_and_Remove_Store' || this.testBucket == '2014w13_Old_Hover_and_Remove_Store' || this.testBucket == 'uiRedesign01LT_A' || this.testBucket == 'uiRedesign01LT_B')
			{
		...
		activate: function()
		{
			...
			if (this.testBucket == '2014w13_Hover_Image_Below_Logic')
			{
